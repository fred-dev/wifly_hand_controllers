...
{ 
  ...
  wifly.setupForUDP<SoftwareSerial>(
    ...
    "pipslabshow2g",  //Your Wifi Name (SSID)
    "pipslabshow", //Your Wifi Password 
    "WiFly",                 // Device name for identification in the network
    "192.168.0.113",         // IP Adress of the Wifly. if 0 (without quotes), it will use dhcp to get an ip
    8000,                    // WiFly receive port
    "192.168.0.101",       // Where to send outgoing Osc messages. "255.255.255.255" will send to all hosts in the subnet
    8001,                     // outgoing port
